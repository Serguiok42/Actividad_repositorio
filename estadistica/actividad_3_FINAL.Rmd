...
author: "Carlos Gálvez Robleño" "Mario Andres Rayo Morales" "Sergio Benítez Fernández" "María Salas Ramos" "Freyda Luisa Encarnación Alejandro" 
date: "2025-02-02"
...
```
**Figura 6.** Gráfico de correlación y visualización de las diferentes variables con los componentes principales 1 y 2. 
...
```{r importancia de cada variable por dimensiones, echo = FALSE, warning=FALSE}
