...
```
**Figura 4.** Porcentaje de varianza explicada para cada componente principal.
...
# ```
```
**Figura 6.** Gráfico de correlación y visualización de las diferentes variables con los componentes principales 1 y 3. 
...
```
**Figura 7.** Gráfico de correlación de las variables por el coseno (cos2) respecto a los componentes principales 1 y 2
...
tabla_combinada_gt <- tabla_combinada_gt %>%
  tab_source_note(
    source_note = "Figura 8. Tabla estadistica. Análisis estadístico de los diferentes genes por terciles para los componentes principales 1 y 2.   Los valores estadísticos se encuentran representados por la media y la desviación estandard y los rangos intercuartilicos (p25-p75). 
...
```
**Figura 9.** Tabla de regresión logística (explicar un poco la tabla y sus caracteristicas)
