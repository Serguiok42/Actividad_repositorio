...
table_results_Regresion %>%
  ...
  opt_table_outline() 
```
**Figura 9.** Tabla de regresión logística: Esta tabla contiene los valores OR y p-valores asociados a las variables predictoras (primera columna de la izquierda) con respecto a la variable dependiente (variable de respuesta binaria: presencia o no de metástasis)
